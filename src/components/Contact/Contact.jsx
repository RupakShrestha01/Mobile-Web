...
const Contact = () => {
  return (
    <section id="contact" class=" relative z-10 overflow-hidden text-white py-20 lg:py-[120px]">
          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                <div class="rounded-full  mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden  bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    class="fill-current bg-orange-500 w-14 h-14 p-4 "
                  >
